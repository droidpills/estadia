...
export default function ServiceClientPage({ hotel, service }: { hotel: Hotel; service: Service }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/${hotel.id}/${service.id}/success`)
  }
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                 ...
                 <div>
                  ...
                  <CustomDatePicker date={selectedDate} setDate={setSelectedDate} placeholder="Selecione uma data" />
                </div>
